...
class _EditRecipeFormState extends State<EditRecipeForm> {
  ...
  Future<void> _confirmAndSaveRecipe() async {
    ...
    if (confirm == true) {
      await _saveEditedRecipe(); // Call the save method if confirmed
    }
  }
  ...
  Future<void> _saveEditedRecipe() async {
    ...
    try {
      ...
      // Fetch updated advice after calculating the nutrients
      ...
      // Update Firestore document with the new advice
      await FirebaseFirestore.instance
        ...
        'riskLevel': riskLevel,
        'advice': advice, // Include the fetched advice here
      });
