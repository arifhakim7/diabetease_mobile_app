...
import 'package:fyp_diabetease/features/view/pages/admin/admin_edit_widget.dart';
...
class AdminRecipeDetailPage extends StatefulWidget {
  ...
  const AdminRecipeDetailPage({Key? key, required this.recipe})
      : super(key: key);
...
class _AdminRecipeDetailPageState extends State<AdminRecipeDetailPage>
  ...
  void _navigateToEditRecipePage(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AdminEditRecipeForm(
          recipe: recipe,
