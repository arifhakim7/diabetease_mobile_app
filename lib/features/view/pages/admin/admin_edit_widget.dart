...
import 'package:fyp_diabetease/features/view/pages/admin/admin_recipe_detail.dart';
import 'package:fyp_diabetease/features/view/widgets/custom_textfield_widget.dart';
import 'package:http/http.dart' as http;

class AdminEditRecipeForm extends StatefulWidget {
  final QueryDocumentSnapshot recipe;
  final Future<void> Function() onRecipeUpdated;

  const AdminEditRecipeForm(
      {required this.recipe, required this.onRecipeUpdated});

  @override
  _AdminEditRecipeFormState createState() => _AdminEditRecipeFormState();
}

class _AdminEditRecipeFormState extends State<AdminEditRecipeForm> {
  ...
  void initState() {
    ...
    _servingController =
        TextEditingController(text: widget.recipe['serving'].toString());
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) =>
                        AdminRecipeDetailPage(recipe: widget.recipe),
                  ),
                );
              },
